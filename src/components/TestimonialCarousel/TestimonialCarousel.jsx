        ...
        <section className="py-16 px-4 bg-gradient-to-br from-slate-50 to-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative">
                    <div
                        ref={carouselRef}
                        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 select-none"
                    ...
                    >
                        {getVisibleCards().map((testimonial, index) => (
                            <div
                                ...
                                className="group relative bg-gradient-to-br from-white to-slate-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-slate-200/50 overflow-hidden"
                            >
                    ...
                    <button
                        ...
                        className={`absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-6 bg-white rounded-full p-4 shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-200 cursor-pointer group ${isTransitioning ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                            }`}
                    ...
                    <button
                        onClick={nextSlide}
                        disabled={isTransitioning}
                        className={`absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-6 bg-white rounded-full p-4 shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-200 cursor-pointer group ${isTransitioning ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                            }`}
